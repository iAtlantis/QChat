...
import com.qchat.mapper.ChatMsgMapper;
import com.qchat.mapper.FriendsRequestMapper;
import com.qchat.mapper.MyFriendsMapper;
import com.qchat.mapper.UsersMapper;
import com.qchat.mapper.UsersMapperCustom;
...
public class UserServiceImpl implements UserService {
	...
	public Users saveUser(Users user) {
		...
		// 为每个用户生成一个唯一的二维码
		String qrCodePath = "/home/soft/image/" + userId + "qrcode.png";
	...
	public String saveMsg(ChatMsg chatMsg) {
		...
		com.qchat.pojo.ChatMsg msgDB = new com.qchat.pojo.ChatMsg();
	...
	@Transactional(propagation = Propagation.SUPPORTS)
	@Override
	public List<com.qchat.pojo.ChatMsg> getUnReadMsgList(String acceptUserId) {
		
		Example chatExample = new Example(com.qchat.pojo.ChatMsg.class);
		Criteria chatCriteria = chatExample.createCriteria();
		chatCriteria.andEqualTo("signFlag", 0);
		chatCriteria.andEqualTo("acceptUserId", acceptUserId);
		
		List<com.qchat.pojo.ChatMsg> result = chatMsgMapper.selectByExample(chatExample);
	...
	public void deleteUser(String username){
		usersMapperCustom.deleteUser(username);
	}
}
