...
import com.qchat.enums.OperatorFriendRequestTypeEnum;
import com.qchat.enums.SearchFriendsStatusEnum;
import com.qchat.pojo.Users;
import com.qchat.pojo.bo.UsersBO;
...
public class UserController {
	...
	public IMoocJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception {
		...
		String userFacePath = "/home/soft/faceImage/" + userBO.getUserId() + "userface64.png";
	...
	public IMoocJSONResult searchUser(String myUserId, String friendUsername)
		...
		if (status == SearchFriendsStatusEnum.SUCCESS.status) {
			System.out.println(myUserId+"add"+friendUsername);
	...
	public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
		...
		// 查询列表
		List<com.qchat.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
		
		return IMoocJSONResult.ok(unreadMsgList);
	}

	@DeleteMapping("/deleteUser")
	public IMoocJSONResult deleteUser(@RequestBody Users user){
		userService.deleteUser(user.getUsername());
		return IMoocJSONResult.ok();
	}


	public IMoocJSONResult upload(@RequestBody MultipartFile multipartFile){
		return null;
	}
